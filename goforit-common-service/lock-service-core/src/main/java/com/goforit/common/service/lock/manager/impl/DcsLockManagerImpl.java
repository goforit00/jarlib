...
public class DcsLockManagerImpl implements DcsLockManager {
    ...
    public DcsResource createSharedResource(LockRequest lockRequest) {
        ...
        DcsResource dcsResource=lockByResourceNameAndType(resourceName, resourceType);

        try{
            if(null==dcsResource){
                dcsResource= DcsResourceConvertor.lockRequest2Bo(lockRequest);

                dcsResource=createResource(dcsResource);

                lockByResourceNameAndType(resourceName,resourceType);
            }
    ...
    @Override
    public void delete(String uniqueBizId) {
    ...
    @Override
    public List<DcsResourceLock> findOthersLock(LockRequest lockRequest) {
        return null;
    }
